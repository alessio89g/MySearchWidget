...
![Shape outlines generated by the Android renderer](assets/screenshots/button-shapes.png)

Vector outlines are shared by the preview and the widget. Shapes persist in configurations and backups. Older backups remain importable; existing Flower configurations use the updated outline. Importing backups with the new shapes requires version 1.8.0 or later.
